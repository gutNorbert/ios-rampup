...
//  ramp-up
//
//  Created by Gutpinter Norbert on 2018. 01. 25..
...
*/
    ...
    func adaptivePresentationStyle(for controller: UIPresentationController) -> UIModalPresentationStyle {
        return .none  //important bec it goes full screen otherwise
    }
        ...
        if let ramp = selectedRamp {
            if gesture.state == .ended{
               ramp.removeAllActions()
                ...
                if gesture.view === rotateBtn { //=== if its in the same spot of the memory - reference
